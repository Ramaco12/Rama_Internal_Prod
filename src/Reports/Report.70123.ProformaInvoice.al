...
// report 52100 "Sales Tax Invoice"
report 70123 "Proforma Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.src\Layout\Proforma Invoice.rdl';
        ...
        dataitem(Integer; Integer)
        {
            ...
            dataitem(PageLoop; Integer)
            {
                ...
                dataitem("Sales Header"; "Sales Header")
                {
                    ...
                    column(SalesInvHdr_DocNo; "Sales Header"."No.")
                    {
                    }
                    ...
                    // column(TotalNoofBox; "Sales Header"."Total No of Box")
                    // {
                    // }
                    column(TotalNoofBox; '')
                    {
                    }
                    // column(BuyerPurchaseOrderNo_SalesInvoiceHeader; "Sales Header"."Buyer Purchase Order No.")
                    // {
                    // }
                    ...
                    column(HeaderBox2Line3; "Sales Header"."External Document No.")
                    {
                    }
                    column(HeaderBox2Line4; "Sales Header"."No.")
                    {
                    }
                    column(HeaderBox2Line5; FORMAT("Sales Header"."Posting Date", 0, '<day,2>-<month,2>-<year4>'))
                    {
                    }
                    column(HeaderBox2Line6; FORMAT("Sales Header"."Posting Date", 0, 4))
                    {
                    }
                    column(HeaderBox2Line7; FORMAT("Sales Header"."Time of Removal"))
                    {
                    }
                    column(HeaderBox2Line8; FORMAT("Sales Header"."Posting Date", 0, 4))
                    {
                    }
                    column(HeaderBox2Line9; ExDutyRate)
                    {
                    }
                    column(HeaderBox3Line1; "Sales Header"."Bill-to Customer No.")
                    {
                    }
                    column(HeaderBox3Line2; "Sales Header"."Bill-to Name")
                    {
                    }
                    column(HeaderBox3Line3; "Sales Header"."Bill-to Address" + ' ' + "Sales Header"."Bill-to Address 2" + '  ' + "Sales Header"."Bill-to City" + ', ' + "Sales Header"."Bill-to Post Code" + ' , ' + billphnno)
                    {
                    }
                    ...
                    column(HeaderBox4Line1; "Sales Header"."Ship-to Name")
                    {
                    }
                    column(HeaderBox4Line2; "Sales Header"."Ship-to Address" + ',' + "Sales Header"."Ship-to Address 2" + ' ' + "Sales Header"."Ship-to City" + ' ' + "Sales Header"."Ship-to Post Code" + ' , ' + billphnno)
                    {
                    }
                    column(HeaderBox4Line3; "Sales Header"."Ship-to County")
                    {
                    }
                    // column(GSTShiptoStateCode_SIH; "Sales Header"."Ship-to State GSTIN No.")
                    // {
                    // }
                    ...
                    column(OrderDate_SIH; FORMAT("Sales Header"."Order Date"))
                    {
                    }
                    column(OrderNo_SIH; '')//"Sales Header"."Order No."
                    {
                    }
                    column(PaymentTermsCode_SIH; "Sales Header"."Payment Terms Code")
                    {
                    }
                    ...
                    // column(TransportMode_; "Sales Header"."Transport Mode")
                    // {
                    // }
                    column(TransportMode_; '')
                    {
                    }
                    column(VehicleNo_; "Sales Header"."Vehicle No.")
                    {
                    }
                    ...
                    // column(Narration_SalesINVHdr; "Sales Header".Narration)
                    // {
                    // }
                    ...
                    // column(Dispatch_Loc; "Sales Header"."Disptach Location")
                    // {
                    // }
                    // column(Dispatch_Name; "Sales Header"."Dispatch Name")
                    // {
                    // }
                    // column(Dispatch_Address; "Sales Header"."Dispatch Address")
                    // {
                    // }
                    // column(Dispatch_Address2; "Sales Header"."Dispatch Address 2")
                    // {
                    // }
                    column(Dispatch_Loc; '')
                    {
                    ...
                    // column(ShiptoContact_SH; "Sales Header"."Ship-to Contact")
                    // {
                    // }
                    column(ShiptoContact_SH; "Sales Header"."Ship-to Phone No.")
                    {
                    }
                    column(IRNNO; IRNNO)
                    {
                    ...
                    // column(B2CQRCode; "Sales Header"."B2C QR Code")
                    // {
                    // }
                    column(B2CQRCode; QrImageB2C) //Changes 28/04/25
                    {
                    }
                    column(PackageTrackingNo_SalesInvoiceHeader; "Sales Header"."Package Tracking No.") //"Sales Header"."Package Tracking No." //PK
                    {
                    }
                    // column(TotalNoofBox_SalesInvoiceHeader; "Sales Header"."Logistics Remarks")
                    // {
                    // }
                    column(TotalNoofBox_SalesInvoiceHeader; '')
                    {
                    }
                    column(CustomerGSTRegNo_SalesInvoiceHeader; "Sales Header"."Customer GST Reg. No.")
                    {
                    }
                    ...
                    dataitem("Sales Line"; "Sales Line")
                    {
                        ...
                        column(SILItemNo; "Sales Line"."No.")
                        {
                        }
                        column(SalesInvLineLnNo; "Sales Line"."Line No.")
                        {
                        }
                        column(Doc_No; "Sales Line"."Document No.")
                        {
                        }
                        column(SNo; SNo)
                        {
                        ...
                        column(SalesInvLineNo; "Sales Line"."No.")
                        {
                        }
                        // column(SalesInvLineDesc; "Sales Line".Description + '  ' + "Sales Line"."Description 2")
                        // {
                        // }
                        ...
                        column(UnitofMeasureCode_SIL; "Sales Line"."Unit of Measure Code")
                        {
                        }
                        column(SalesInvLinUnitPerParcel; "Sales Line"."Units per Parcel")
                        {
                        }
                        column(SalesInvLinQty; "Sales Line".Quantity)
                        {
                        }
                        column(SalesInvLinUnitPrice; "Sales Line"."Unit Price")
                        {
                        }
                        column(SalesInvLinLnAmt; "Sales Line"."Line Amount")
                        {
                        }
                        /* column(SalesInvLinXciseAmt; "Sales Line"."Excise Amount")
                        {
                        }
                        column(AmountToCustomer_SIL; "Sales Line"."Amount To Customer")
                        {
                        } */
                        //PK_16/01/25
                        ...
                        column(LineDiscount_SIL; "Sales Line"."Line Discount Amount")
                        {
                        }
                        /* column(AssessableValue_SIL; "Sales Line"."Assessable Value")
                        {
                        }
                        column(GSTBaseAmount_SIL; "Sales Line"."GST Base Amount")
                        {
                        }
                        column(TotalGSTAmount_SIL; "Sales Line"."Total GST Amount")
                        {
                        } */
                        //PK_16/01/25 Temp
                        ...
                        column(GSTBaseAmount_SIL; "Sales Line"."Line Amount")
                        {
                        }
                        column(TotalGSTAmount_SIL; '')
                        {
                        }
                        column(UnitPrice_SIL; "Sales Line"."Unit Price")
                        {
                        }
                        ...
                        // column(PartCode; "Sales Line"."Part Code")
                        // {
                        // }
                        column(PartCode; '')
                        {
                        ...
                        // column(Dis_per; "Sales Line"."Dis.%")
                        // {
                        // }
                        column(Dis_per; '')
                        {
                        }
                        // column(amount; "Sales Line"."GST Base Amount") { }
                        column(amount; "Sales Line".Amount) { }
                        // column(Gstamt; "Sales Line"."Total GST Amount") { }
                        ...
                        column(Type_SalesInvoiceLine; "Sales Line".Type)
                        {
                        }
                        ...
                        begin
                            SNo += 1;
                            TotNoOfPkgs := 0;
                            IF "Sales Line"."Units per Parcel" > 0 THEN BEGIN
                                TotNoOfPkgs := "Sales Line".Quantity / "Sales Line"."Units per Parcel";
                            END;
                            IF "Sales Line".Type = "Sales Line".Type::Item THEN
                                qtytotal += "Sales Line".Quantity;

                            //IF ("Sales Line"."No." <> '') AND ("Sales Line".Type = "Sales Line".Type::Item) THEN BEGIN
                            IF ("Sales Line"."No." <> '') THEN BEGIN //PK_24/04/26
                                ctr += 1;
                                CtrTExt := FORMAT(ctr);
                            END ELSE
                                CtrTExt := '';
                            ...
                            HSNCode := '';
                            //HSNCode :=COPYSTR("Sales Line"."HSN/SAC Code",1,4);
                            HSNCode := "Sales Line"."HSN/SAC Code";

                            // TJ 27Feb26 +++
                            // if not IsCounted then begin

                            //     SalesInvHdr.Get("Sales Header"."No.");
                            ...
                            IF "Sales Header"."Currency Code" <> '' THEN BEGIN
                                CGSTAmt := CGSTAmt * "Sales Header"."Currency Factor";
                                SGSTAmt := SGSTAmt * "Sales Header"."Currency Factor";
                                IGSTAmt := IGSTAmt * "Sales Header"."Currency Factor";
                                TotalGSTNew := TotalGSTNew * "Sales Header"."Currency Factor";  //PK
                                TotalAmtToCust := "Sales Header"."Amount Including VAT" * "Sales Header"."Currency Factor";
                            END;
                            //LFS-KB-10251--
                                ...
                                repeat
                                    ...
                                    if (RecTAXTransValue."Tax Type" = 'GST') and (CompID = RecTAXTransValue."Value ID") then begin
                                        if TaxCompName = 'CGST' then begin
                                            ...
                                            TotalGSTNew += RecTAXTransValue.Amount;
                                        end
                                        else
                                            if TaxCompName = 'SGST' then begin
                                                ...
                                                if TaxCompName = 'IGST' then begin
                                                    ...
                                                    //     TotalIGStLineAmt += RecTAXTransValue.Amount;//     //Only Line GST
                                                end;
                                        // GSTPer += RecTAXTransValue.Percent;
                                        NetAmt := (TotalCGSTAmt + TotalSGSTAmt + TotalIGSTAmt);

                                        //GstValue := IGSTAmt * ExchangeRate;
                                    end
                                    else
                                        if (RecTAXTransValue."Tax Type" = 'TDS') and (RecTAXTransValue."Value ID" = 1) then begin
                            ...
                            TotalNetAmt := "Sales Line"."Line Amount" + NetAmt;
                            // TotalAmtRecdINRVar += (TotalNetAmt - TaxAmt1);

                            if TotalGSTNew <> 0 then begin
                                CheckGSTAppli := true;
                                TaxCaption := GetTaxCaption("Sales Header", CheckGSTAppli);
                            end;
                            //GST Code ----

                            //Comm GST PK_13/01/25
                            /* StructureLineDetails.RESET;
                            StructureLineDetails.SETRANGE("Invoice No.", "Sales Line"."Document No.");
                                        ...
                                        IF (ItemLedgEntry."Document Type" = ItemLedgEntry."Document Type"::"Sales Shipment") THEN
                                            IF SalesShptLine.GET(ItemLedgEntry."Document No.", ItemLedgEntry."Document Line No.") THEN BEGIN
                                                ...
                                                END ELSE BEGIN
                                                    ...
                                                    PostedSalesSerialNo.SETRANGE(PostedSalesSerialNo."Document No.", "Sales Line"."Document No.");
                                                    PostedSalesSerialNo.SETRANGE(PostedSalesSerialNo."Line No.", "Sales Line"."Line No.");
                            ...
                            //Comm GST PK_13/01/25
                            /* IF "Sales Line"."TDS/TCS Amount" <> 0 THEN BEGIN
                                TCSPer := '@ ' + FORMAT("Sales Line"."TDS/TCS %") + ' %';
                                TcsAmt += "Sales Line"."TDS/TCS Amount";
                            END; */

                            TotalLineAmt += "Sales Line"."Line Amount";
                            TotalAmtToCustomer += "Sales Line"."Amount Including VAT";
                            // TotalGSTBaseAmt += "Sales Line"."Total GST Amount";//LFS-IS  //Comm GST PK_13/01/25
                            TotalGSTBaseAmt += TotalGSTNew; //PK_New
                            TotalAmount := ROUND(TotalAmtToCustomer + TotalGSTBaseAmt + TcsAmt, 1); //LFS-IS
                                                                                                    //ELSE
                                                                                                    //TotalAmtToCustomer += "Sales Line"."Amount To Customer"-InvoiceRoundoff;

                            //MRP_18/09/25 ++
                            UserSetup.Reset();
                            LocationRec.Reset();
                            LocationRec.SetRange(Code, "Sales Header"."Location Code");
                            if LocationRec.FindFirst() then
                                /* if LocationRec."Sales Invoice Print" = false then begin
                                    ...
                                    if UserSetup."Super User" = false then begin
                                        ...
                                        if ("Sales Header"."E-Way Bill No." = '') AND (TotalAmount > 50000) then
                            ...
                            // //RepCheck[1].FormatNoText(NoText,TotalAmtToCustomerInvrounding,"Sales Header"."Currency Code");
                            // "Sales Header".CALCFIELDS("Sales Header"."Amount Including VAT");
                            // RepCheck[1].FormatNoText(NoText, ROUND("Sales Header"."Amount Including VAT" + TcsAmt + TotalGSTBaseAmt, 1), "Sales Header"."Currency Code");  //2573
                            //TotalAmountNew := ROUND("Sales Header"."Amount Including VAT" + TcsAmt + TotalGSTBaseAmt, 1);
                            ...
                            //PK_24/04/26 ++
                            if "Sales Header"."Currency Code" = 'AED' then begin
                                AmountInWords := NumberInWordsAED(TotalAmount, '', 'AED');
                            end;
                            if "Sales Header"."Currency Code" = 'QAR' then begin
                                AmountInWords := NumberInWordsQAR(TotalAmount, '', 'QAR');
                            end;
                            //PK_24/04/26 --
                            if ("Sales Header"."Currency Code" = '') or ("Sales Header"."Currency Code" = 'INR') then begin
                    ...
                    begin
                        ...
                        /* IF "Sales Header"."Nature of Supply" = "Sales Header"."Nature of Supply"::B2C THEN
                            // IF NOT "Sales Header"."IRN No. Generated" THEN
                               IF NOT ("Sales Header"."IRN HASH" <> '') THEN
                                IF "Sales Header"."QR Code".HASVALUE THEN
                                    "Sales Header".CALCFIELDS("Sales Header"."QR Code"); */
                        ...
                        // Get values from location if not blank
                        CLEAR(billphnno);
                        IF reccust.GET("Sales Header"."Ship-to Code") THEN BEGIN
                        ...
                        IF "Ship-to Code" <> '' THEN BEGIN
                            ShipRec.RESET;
                            ShipRec.SETFILTER(ShipRec.Code, "Sales Header"."Ship-to Code");
                            ShipRec.SETFILTER(ShipRec."Customer No.", "Sales Header"."Bill-to Customer No.");
                            IF ShipRec.FINDFIRST THEN BEGIN
                                ShipToCode := ShipRec.Code;
                                shiptin := ShipRec."GST Registration No.";
                                /* IF ShipState.GET("Sales Header"."Ship-to State") THEN BEGIN //LFS-AS-6516
                                    ShipStateCode := ShipState."State Code (GST Reg. No.)";
                                    ShipStateDescr := ShipState.Description;
                                END; */
                            END;
                        END ELSE BEGIN
                            ShipToCode := "Sales Header"."Bill-to Customer No.";
                            /* IF "Sales Header"."Ship-to State" = customer."State Code" THEN
                                IF "Sales Header"."GST Customer Type" = "Sales Header"."GST Customer Type"::"SEZ Unit" THEN BEGIN //lFS-MR-11699++
                                    IF customer.GET("Sales Header"."Bill-to Customer No.") THEN
                                        shiptin := customer."GST Registration No."
                                    // shiptin  := CustGSTReg
                                END ELSE begin
                                    //lFS-MR-11699--
                                    shiptin := "Sales Header"."Customer GST Reg. No.";    //LFS-CG-11699

                                    //PK_17/12/25 ++ Tukaram ji
                                    if "Sales Header"."Ship-to Address" <> "Sales Header"."Sell-to Address" then
                                        shiptin := "Sales Header"."Ship-to State GSTIN No.";
                                    //PK_17/12/25 --
                                end
                            ELSE
                                shiptin := "Sales Header"."Ship-to State GSTIN No.";
                            ...
                            shipEccNo := CustECCNo;
                            Shipdate := Date;
                            IF "Sales Header"."Ship-to State" <> '' THEN
                                IF ShipState.GET("Sales Header"."Ship-to State") THEN BEGIN
                                    ShipStateCode := ShipState."State Code (GST Reg. No.)";
                                    ShipStateDescr := ShipState.Description;
                                END; */
                        END;
                        ...
                        //CompanyInfo.GET;
                        IF CompanyInfo."Name Change Effective Date" <= "Sales Header"."Posting Date" THEN BEGIN
                        ...
                        //LFS-ASP-  ++
                        IF (("Sales Header"."Currency Code" = 'INR') OR ("Sales Header"."Currency Code" = '')) THEN BEGIN
                            Rs := '₹';
                        END ELSE
                            IF "Sales Header"."Currency Code" = 'USD' THEN BEGIN
                                Rs := '$';
                        ...
                        ClearTaxOutputList.SETRANGE("e_Document No.", "Sales Header"."No.");
                        ...
                        CLEAR(CUstomerPAN);
                        Customer_GRec.RESET;
                        Customer_GRec.SETRANGE("No.", "Sales Header"."Bill-to Customer No.");
                        IF Customer_GRec.FINDFIRST THEN
                            CUstomerPAN := Customer_GRec."P.A.N. No.";
                        //LFS-AY-20.10.2020--

                        //LFS-NG-7857 >>
                        /* IF "Sales Header"."GST Customer Type" = "Sales Header"."GST Customer Type"::"SEZ Unit" THEN BEGIN
                            LocationARNMaster.GetARNandRelatedFeilds("Sales Header"."Location Code", "Sales Header"."Posting Date",
                            NoteTextforPrint);
                        END; */
                        //LFS-NG-7857 <<
                        //LFS-SG-8886++
                        Dimension.RESET;
                        Dimension.SETRANGE("Dimension Set ID", "Sales Header"."Dimension Set ID");
                        ...
                        END ELSE
                            CustGSTNo := "Sales Header"."Customer GST Reg. No.";
                        //LFS-MR-11699--
                        ...
                        "Sales Header".CalcFields("Sales Header"."QR Code");
                        "Sales Header"."QR Code".CreateInStream(QRCodeInStreamB2C);
                        ...
                        if "Sales Header"."Vendor Code" <> '' then begin
                            if "Sales Header"."Vendor Order Address Code" <> '' then begin
                                OrderAddress.Reset();
                                OrderAddress.SetRange("Vendor No.", "Sales Header"."Vendor Code");
                                OrderAddress.SetRange(Code, "Sales Header"."Vendor Order Address Code");
                                if OrderAddress.FindFirst() then begin
                                    Dispatch_PinCode := OrderAddress."Post Code";
                                end;
                            end else begin
                                RecVendor.Reset();
                                RecVendor.SetRange("No.", "Sales Header"."Vendor Code");
                                if RecVendor.FindFirst() then begin
                                    Dispatch_PinCode := RecVendor."Post Code";
                                end;
                            end;
                        end;
                        if "Sales Header"."Disptach Location" <> '' then begin
                            DispLocation.Reset();
                            DispLocation.SetRange(Code, "Sales Header"."Disptach Location");
                        ...
                        TaxCaption := GetTaxCaption("Sales Header", CheckGSTAppli);
                        VATEntry1.Reset();
                        VATEntry1.SetRange("Document No.", "Sales Header"."No.");
                    ...
                    begin
                        ...
                        //"Sales Header"."No."
                        IF documntno <> '' THEN
                            "Sales Header".SETRANGE("No.", documntno);
                    end;
                }
            }
            ...
            begin
                ...
                //GST Code
                ReqFiltNo := "Sales Header".GetFilter("No.");
            end;
        }
    }
    ...
    begin
        ...
        IF RunSerialNoREport = TRUE THEN
            RunSalesInvSerialNoReport("Sales Header"."No.");
        //LFS-AK-3651--
    end;
    ...
    var
        ...
        InvoiceType: Option "PROFORMA INVOICE","BILL OF SUPPLY","DEBIT NOTE";
        HeaderTxt: Text;
    ...
    //TAX Caption
    local procedure GetTaxCaption(SalesHeader: Record "Sales Header"; GSTBoolean: Boolean): Text
    var
    ...
    begin
        ...
        if SalesHeader."VAT Bus. Posting Group" = 'WHT' then
            exit('WHT');
